...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /home/suryaansh/orangewood_ws/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_grasp_plugin)
  set(gazebo_grasp_plugin_DEVEL_PREFIX /home/suryaansh/orangewood_ws/devel)
  ...
  set(gazebo_grasp_plugin_INSTALL_PREFIX /home/suryaansh/orangewood_ws/install)
...
if(NOT "/home/suryaansh/orangewood_ws/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_grasp_plugin/include " STREQUAL " ")
  set(gazebo_grasp_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/home/suryaansh/orangewood_ws/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_grasp_plugin/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/suryaansh/orangewood_ws/src/orangewood_sim_stack/3rd_party_pkgs/gazebo_grasp_plugin/${idir}'.  ${_report}")
    endif()
